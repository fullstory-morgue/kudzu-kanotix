...
typedef struct bus_operations {
    ...
    void	(*b_outs)(void *bus, u32 port, void *buf,
			  u32 count, s32 sz);
    void	*(*b_ioremap)(void *bus, unsigned long ofs, unsigned long sz);
    ...
    int		(*b_request_irq)(void *bus, unsigned int irq,
				 void (*handler)(int, void *,
						 struct pt_regs *),
				 unsigned long flags, const char *device,
				 void *dev_id);
    void	(*b_free_irq)(void *bus, unsigned int irq, void *dev_id);
} bus_operations;
