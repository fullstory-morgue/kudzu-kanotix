...
typedef struct config_info_t {
    unsigned char	Function;
    unsigned int	Attributes;
    unsigned int	Vcc, Vpp1, Vpp2;
    unsigned int	IntType;
    unsigned int	ConfigBase;
    unsigned char	Status, Pin, Copy, Option, ExtStatus;
    unsigned int	Present;
    unsigned int	CardValues;
    unsigned int	AssignedIRQ;
    unsigned int	IRQAttributes;
    ioaddr_t	BasePort1;
    ioaddr_t	NumPorts1;
    unsigned int	Attributes1;
    ioaddr_t	BasePort2;
    ioaddr_t	NumPorts2;
    unsigned int	Attributes2;
    unsigned int	IOAddrLines;
} config_info_t;
...
typedef struct config_req_t {
    ...
    unsigned int	IntType;
    unsigned int	ConfigBase;
    unsigned char	Status, Pin, Copy, ExtStatus;
...
typedef struct irq_req_t {
    unsigned int	Attributes;
    unsigned int	AssignedIRQ;
    unsigned int	IRQInfo1, IRQInfo2;
    void	*Handler;
    void	*Instance;
} irq_req_t;
...
typedef int (*ss_entry_t)(unsigned int sock, unsigned int cmd, void *arg);
